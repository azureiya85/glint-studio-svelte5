<script lang="ts">
  ...
  import RegisterForm from '$lib/components/molecule/RegisterForm.svelte';
</script>

<svelte:head>
  <title>Register | Designer</title>
  <meta name="description" content="Create a new account on Designer to access exclusive features." />
</svelte:head>
