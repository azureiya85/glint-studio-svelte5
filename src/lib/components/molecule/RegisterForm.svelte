  ...
  <form class="space-y-4" on:submit={handleRegister}>
    <label class="block text-sm font-medium text-slate-200">
      ...
      <input
        ...
        class="input-field w-full mt-1 p-2 rounded bg-primary-800 border border-tertiary-800 text-white"
        bind:value={email}
        required
      />
    </label>
    ...
    <button
      type="button"
      class="w-full rounded-full bg-red-800 hover:bg-red-700 text-white py-2 border border-tertiary-800 transition-all"
